...
const images = [
    {
        ...
        description: "Take the scenic route. Explore the city or the countryside, one pedal at a time.",
    },
    {
      url: "https://rare-gallery.com/mocahbig/5427427-aespa-kpop-better-things-karina-winter-ningning.jpg",
      name: "BikerTown",
      description: "Discover the freedom of two wheels with BikeTown — where every ride is an adventure waiting to happen.",
    },
    {
      url: "https://rare-gallery.com/mocahbig/5427428-aespa-kpop-better-things-winter-ningning-karina.jpg",
      name: "Ride More",
      description: "Experience the road like never before. Fast, smooth, and eco-friendly transportation at your fingertips.",
    },
    {
      url: "https://media-cdn-v2.laodong.vn/Storage/NewsPortal/2022/7/27/1073590/Fyvqmlpuiaa1ii3-01.jfif",
      name: "Urban Escape",
      description: "Escape the hustle. Find serenity and speed on two wheels wherever you go.",
    },    
    {
    ...
    },
    {
      ...
      description: "Unleash your inner rebel with bikes that match your attitude.",
    },
  ];
